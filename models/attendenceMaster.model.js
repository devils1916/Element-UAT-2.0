...
const AttendenceMaster = element.define('AttendenceMaster', {
    AttendenceID: {
    ...
    EmpType: { type: DataTypes.STRING(25), allowNull: false }            // NOT NULL in live
}, {
    tableName: 'AttendenceMaster',
    timestamps: false
});

module.exports = AttendenceMaster;
