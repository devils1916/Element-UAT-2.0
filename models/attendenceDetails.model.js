...
const   AttendanceDetail = element.define('AttendanceDetail', {
  ID: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
  },
  AttendenceCode: { type: DataTypes.STRING(25) },
  ...
  PresentDays: { type: DataTypes.DECIMAL(24, 2) },
  ...
  OTDays: { type: DataTypes.DECIMAL(18, 2) },
  OTHours: { type: DataTypes.DECIMAL(18, 2) },
}, {
